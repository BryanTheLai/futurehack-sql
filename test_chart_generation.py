...
# Quick test to verify chart generation is working

import os
from src.cogniquery_crew.tools.logged_code_interpreter import LoggedCodeInterpreterTool

def test_chart_creation():
    """Test that the LoggedCodeInterpreterTool can create charts."""
    
    # Ensure output directory exists
    os.makedirs("output", exist_ok=True)
    
    # Create the tool
    code_tool = LoggedCodeInterpreterTool()
...
print("Chart saved as: output/test_chart.png")
'''
